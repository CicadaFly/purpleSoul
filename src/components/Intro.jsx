  ...
  return (
      ...
      <div className='pl-6 py-4'>
       <ul className='list-disc text-black'>
        ...
        <li className='mb-1'>填寫完畢後，點選<span className='font-semibold underline'>"送出"</span>至選牌頁，並在3個類別內，默念您的問題並憑直覺各選一張卡。</li>
        <li>點選<span className='font-semibold underline'>"我選好了"</span>後，即會抵達結果頁，想進一步了解結果，請截圖該頁面，至洋羽占卜鋪IG與占卜小姐姐預約解牌時段。</li>
       </ul>
